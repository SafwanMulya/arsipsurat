        ...
        <div class="flex">
            <div class="bg-white shadow-lg rounded-xl p-10  w-full bg-gradient-to-r from-blue-800 to-blue-400 flex">
                <div class="">
                    ...
                    <a href="https://arsip.test/admin"
                        class="inline-block mt-6 px-6 py-3 bg-gradient-to-r from-yellow-700 to-yellow-500 text-white font-semibold rounded-xl hover:bg-yellow-400 transition">
                        Mulai Arsip
                    </a>
                </div>
                ...
                <div class="px-4 py-3 bg-gradient-to-r from-blue-800 to-blue-400 border-b border-gray-200">
                    <div class="text-gray-100 font-semibold flex items-center gap-2">
                        ...
                        <a href="{{ route('suratmasuks.index') }}"
                            class="btn px-4 py-1 bg-gradient-to-r from-green-600 to-green-400 ml-auto rounded-md text-sm flex gap-2 ">Selengkapnya<svg
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-sm font-bold text-gray-500 uppercase">Kategori</th>
                                <th class="px-4 py-2 text-left text-sm font-bold text-gray-500 uppercase">Asal Surat</th>
                                <th class="px-4 py-2 text-left text-sm font-bold text-gray-500 uppercase">Tanggal Masuk
                                </th>
                            </tr>
                        </thead>
